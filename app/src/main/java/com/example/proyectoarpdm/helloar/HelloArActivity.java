...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  private void showOcclusionDialogIfNeeded() {
    ...
    new AlertDialog.Builder(this)
        ...
        .setPositiveButton(
            com.example.proyectoarpdm.R.string.button_text_enable_depth,
            (DialogInterface dialog, int which) -> {
              depthSettings.setUseDepthForOcclusion(true);
            })
        .setNegativeButton(
            com.example.proyectoarpdm.R.string.button_text_disable_depth,
            (DialogInterface dialog, int which) -> {
  ...
  private void launchInstantPlacementSettingsMenuDialog() {
    ...
    new AlertDialog.Builder(this)
        ...
        .setMultiChoiceItems(
            resources.getStringArray(com.example.proyectoarpdm.R.array.instant_placement_options_array),
            instantPlacementSettingsMenuDialogCheckboxes,
            (DialogInterface dialog, int which, boolean isChecked) ->
                instantPlacementSettingsMenuDialogCheckboxes[which] = isChecked)
        .setPositiveButton(
            com.example.proyectoarpdm.R.string.done,
  ...
  private void launchDepthSettingsMenuDialog() {
    ...
    if (session.isDepthModeSupported(Config.DepthMode.AUTOMATIC)) {
      ...
      new AlertDialog.Builder(this)
          .setTitle(com.example.proyectoarpdm.R.string.options_title_with_depth)
          .setMultiChoiceItems(
              resources.getStringArray(com.example.proyectoarpdm.R.array.depth_options_array),
